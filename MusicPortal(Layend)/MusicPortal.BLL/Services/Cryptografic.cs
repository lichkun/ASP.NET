...
namespace MusicPortal.Services
{
    public class Cryptografic : IEncryption
    {
        ...
        public string Decryption(UserDTO curUser, string pass)
        {
        ...
        public string Encryptyion(UserDTO reg, string salt="")
        {
        ...
        public void SaveSaltToDatabase(UserDTO reg, string salt)
        {
